...
// Validate checks the field values on RelationNodeSelector with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RelationNodeSelector) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RelationNodeSelector with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RelationNodeSelectorMultiError, or nil if none found.
func (m *RelationNodeSelector) ValidateAll() error {
	return m.validate(true)
}

func (m *RelationNodeSelector) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, RelationNodeSelectorValidationError{
					field:  "ObjectSelector",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return RelationNodeSelectorValidationError{
				field:  "ObjectSelector",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return RelationNodeSelectorMultiError(errors)
	}

	return nil
}

// RelationNodeSelectorMultiError is an error wrapping multiple validation
// errors returned by RelationNodeSelector.ValidateAll() if the designated
// constraints aren't met.
type RelationNodeSelectorMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RelationNodeSelectorMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RelationNodeSelectorMultiError) AllErrors() []error { return m }

// RelationNodeSelectorValidationError is the validation error returned by
// RelationNodeSelector.Validate if the designated constraints aren't met.
type RelationNodeSelectorValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RelationNodeSelectorValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RelationNodeSelectorValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RelationNodeSelectorValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RelationNodeSelectorValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RelationNodeSelectorValidationError) ErrorName() string {
	return "RelationNodeSelectorValidationError"
}

// Error satisfies the builtin error interface
func (e RelationNodeSelectorValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRelationNodeSelector.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RelationNodeSelectorValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RelationNodeSelectorValidationError{}
...
func (m *ObjectSelector) validate(all bool) error {
	...
	case *ObjectSelector_ObjectSpec:
		if v == nil {
		...
		if all {
			switch v := interface{}(m.GetObjectSpec()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
		...
		} else if v, ok := interface{}(m.GetObjectSpec()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
	...
	case *ObjectSelector_ResourceSpec:
		if v == nil {
			err := ObjectSelectorValidationError{
				field:  "Selector",
				reason: "oneof value cannot be a typed-nil",
...
func (m *RelationSelector) validate(all bool) error {
	...
	switch v := m.Selector.(type) {
	case *RelationSelector_RelationName:
		if v == nil {
...
func (m *SubjectSelector) validate(all bool) error {
	...
	switch v := m.Selector.(type) {
	case *SubjectSelector_SubjectSpec:
		if v == nil {
		...
		if all {
			switch v := interface{}(m.GetSubjectSpec()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
		...
		} else if v, ok := interface{}(m.GetSubjectSpec()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
	...
	case *SubjectSelector_ResourceSpec:
		if v == nil {
			err := SubjectSelectorValidationError{
				field:  "Selector",
				reason: "oneof value cannot be a typed-nil",
		...
		// no validation rules for ResourceSpec
	case *SubjectSelector_SubjectGroup:
		if v == nil {
			err := SubjectSelectorValidationError{
				field:  "Selector",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetSubjectGroup()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SubjectSelectorValidationError{
						field:  "SubjectGroup",
		...
		} else if v, ok := interface{}(m.GetSubjectGroup()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return SubjectSelectorValidationError{
					field:  "SubjectGroup",
					reason: "embedded message failed validation",
...
// Validate checks the field values on SubjectGroupSelector with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SubjectGroupSelector) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SubjectGroupSelector with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SubjectGroupSelectorMultiError, or nil if none found.
func (m *SubjectGroupSelector) ValidateAll() error {
	return m.validate(true)
}

func (m *SubjectGroupSelector) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SubjectGroupSelectorMultiError(errors)
	}

	return nil
}

// SubjectGroupSelectorMultiError is an error wrapping multiple validation
// errors returned by SubjectGroupSelector.ValidateAll() if the designated
// constraints aren't met.
type SubjectGroupSelectorMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SubjectGroupSelectorMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SubjectGroupSelectorMultiError) AllErrors() []error { return m }

// SubjectGroupSelectorValidationError is the validation error returned by
// SubjectGroupSelector.Validate if the designated constraints aren't met.
type SubjectGroupSelectorValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SubjectGroupSelectorValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SubjectGroupSelectorValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SubjectGroupSelectorValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SubjectGroupSelectorValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SubjectGroupSelectorValidationError) ErrorName() string {
	return "SubjectGroupSelectorValidationError"
}

// Error satisfies the builtin error interface
func (e SubjectGroupSelectorValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSubjectGroupSelector.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SubjectGroupSelectorValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SubjectGroupSelectorValidationError{}
